...
alias ......="cd ../../../../../.."
alias py="python3"
alias ls="eza -TlL 2 --git --total-size --no-permissions --no-user --no-time --icons=always"
alias lsa="eza -TlaL 1 --git --total-size --no-permissions --no-user --no-time --icons=always"
